...
<div class="employee-view">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <?= $form->field($emp, 'branch_id')->dropDownList(\backend\models\Branch::getAll(),['prompt'=>Yii::t('app','--Select--'),'disabled'=>'disabled']) ?>

            <?= $form->field($emp, 'department_id')->dropDownList(\backend\models\Department::getAll(),['prompt'=>Yii::t('app','--Select--'),'disabled'=>'disabled']) ?>
